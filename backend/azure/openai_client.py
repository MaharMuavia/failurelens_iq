...
class AzureOpenAIClient:
    ...
    def _build_failure_report_prompt(self, ctx: AgentContext) -> str:
        ...
        return (
            "Create a concise FailureLens IQ executive summary with these sections: "
            "executive summary, risk summary, next best action, confidence caveat. "
            "Use only concise reasoning summaries; do not expose hidden chain of thought.\n\n"
